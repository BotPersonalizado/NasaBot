...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[2]} +51920011639
  ${tradutor.texto1[3]} paypal.me/AlexisPisco658
  ...
  const Message = {
    document: { url: `https://www.whatsapp.com/channel/0029Varplf3EwEjoUMw34V13` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.whatsapp.com/channel/0029Varplf3EwEjoUMw34V13",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐍𝐀𝐒𝐀 𝐁𝐎𝐓",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.whatsapp.com/channel/0029Varplf3EwEjoUMw34V13",
      },
    },
    caption: info,
    footer: wm,
